    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-5 py-20 sm:px-8 sm:py-24 lg:px-14 lg:py-28 xl:px-20">
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20">
          ...
          {/* IMAGE SIDE WITH DYNAMIC TABS */}
          <div className="relative">
            {/* Interactive Image Selector Tabs */}
            <div className="mb-4 flex gap-2">
              {visualOptions.map((item) => (
                <button
                  key={item.id}
                  onClick={() => setActiveVisual(item)}
                  className={`px-3 py-1.5 text-[9px] font-mono font-bold uppercase tracking-wider transition-all duration-300 border ${
                    activeVisual.id === item.id
                      ? "bg-[#153B16] text-[#E5CC64] border-[#153B16]"
                      : "bg-white/80 text-[#153B16]/70 border-[#153B16]/15 hover:border-[#153B16]"
                  }`}
                >
                  {item.label}
                </button>
            ...
            {/* Image Frame */}
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#153B16] sm:aspect-[5/4] lg:aspect-[4/5] shadow-2xl">
              <img
              ...
              {/* Green Overlay */}
              <div className="absolute inset-0 bg-[#153B16]/20 mix-blend-multiply" />

              {/* Gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#153B16]/90 via-[#153B16]/20 to-transparent" />
            ...
            {/* Gold Corner Accents */}
            <div className="absolute -bottom-3 -right-3 h-20 w-20 border-b border-r border-[#E5CC64] sm:-bottom-4 sm:-right-4 sm:h-24 sm:w-24 pointer-events-none" />
            <div className="absolute -left-3 -top-3 h-14 w-14 border-l border-t border-[#E5CC64]/60 sm:-left-4 sm:-top-4 sm:h-16 sm:w-16 pointer-events-none" />
          </div>
          ...
          <div>
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-black sm:text-base sm:leading-8">
              Bhatia Ocean Gold International connects African resources with global markets through responsible sourcing, commodity trading, export coordination and international B2B supply.
            </p>

            <p className="mt-4 max-w-2xl text-sm leading-7 text-black sm:text-base sm:leading-8">
              Our business focus spans mining, gold, copper, minerals, commodity trading, international trading and export.
            </p>
            ...
            <div className="mt-10 grid grid-cols-2 border-l border-t border-[#153B16]/15 sm:grid-cols-4">
              {[
                ...
                { label: "Gold Trading & Export", href: "/products/gold" },
                { label: "Copper & Cathodes", href: "/products/copper" },
            ...
            <div className="mt-9 flex flex-col gap-5 sm:flex-row sm:items-center">
              ...
              <Link
                ...
                className="group inline-flex w-fit items-center gap-2 border-b border-[#153B16]/25 pb-2 text-[9px] font-bold uppercase tracking-[0.2em] text-[#153B16] transition-colors hover:border-[#E5CC64]"
              >
                How We Operate
                <ArrowRight
                  size={13}
